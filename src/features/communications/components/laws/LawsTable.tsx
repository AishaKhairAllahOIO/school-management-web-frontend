          ...
          <TableBody>
            {laws.map((law) => (
              <TableRow key={law.id} className="border-border/45 hover:bg-muted/[0.14]">
                {/* Law */}
                <TableCell className="w-[28%] px-5 py-4 align-top">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="pt-1.5 text-[13px] font-medium leading-5 text-foreground break-words" dir="auto">
                      {law.title}
                    </span>
                  </div>
                </TableCell>
                ...
                <TableCell className="px-5 py-4 align-top">
                  <p className="whitespace-normal break-words text-[12px] leading-[19px] text-muted-foreground" dir="auto">
                ...
                <TableCell className="w-[180px] px-5 py-4 align-top">
                  <div className="flex items-center justify-end gap-1.5 whitespace-nowrap">
                    <Button
                      ...
                      size="sm"
                      onClick={() => onEdit(law)}
                      className="h-9 shrink-0 rounded-[11px] border-border/65 bg-transparent px-3 text-[11px] font-medium text-success hover:bg-success/[0.08] hover:text-success"
                    >
                    ...
                    <Button
                      ...
                      className="h-9 shrink-0 rounded-[11px] border-border/65 bg-transparent px-3 text-[11px] font-medium text-destructive hover:bg-destructive/[0.06] hover:text-destructive"
                    >
