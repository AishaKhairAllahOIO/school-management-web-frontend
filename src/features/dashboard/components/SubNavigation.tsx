...
function FolderItem({
  ...
  const folderAnimationData = useMemo(
    () => getFolderAnimation(color),
    [color]
  );
    ...
    <NavLink to={path} className="group relative shrink-0">
      ...
      >
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-1 px-2 pt-5">
          ...
          <span className="text-center text-[13px] font-medium leading-tight text-white">
            {title}
          </span>
        </div>
      </div>
  ...
  return (
    <div className="px-4 pt-5 md:px-6 lg:px-8">
      <div className="page-shell">
        <nav
          className={[
            "flex max-w-full overflow-x-auto pb-4",
