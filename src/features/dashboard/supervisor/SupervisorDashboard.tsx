      ...
      <div className="rounded-[1.5rem] border border-border/60 bg-card p-5 shadow-[0_8px_30px_rgba(148,163,184,0.07)]">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          {data.classes.map((cls) => (
            <div
              key={cls.class_id}
              className="group relative overflow-hidden rounded-2xl border border-border/50 bg-gradient-to-br from-sky-50/70 via-card to-card p-4 text-center transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md"
            >
              <div className="absolute -right-5 -top-5 h-16 w-16 rounded-full bg-sky-100/60 blur-xl transition-transform duration-300 group-hover:scale-125" />
