          ...
          <div className="flex flex-1 flex-col p-3.5">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              {Array.from({ length: 2 }).map((__, rowIndex) => (
                <div key={rowIndex} className="flex min-w-0 items-center gap-2.5 rounded-2xl border border-border/55 bg-muted/25 px-3 py-2.5">
                  <div className="h-8 w-8 shrink-0 animate-pulse rounded-xl bg-muted" />
                  <div className="min-w-0 flex-1">
                    <div className="h-2.5 w-14 animate-pulse rounded bg-muted/75" />
