          ...
          {historyQuery.isPending ? (
            <div className="grid gap-3">
              {Array.from({ length: 4 }).map((_, index) => (
                <div
                  key={index}
                  className="flex animate-pulse items-center justify-between gap-4 rounded-[18px] border border-border/60 bg-card p-4"
                >
                  <div className="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 h-3 w-36 max-w-full rounded bg-muted/70" />
                    </div>
                  </div>
                  <div className="h-10 w-28 shrink-0 rounded-xl bg-muted/70" />
                </div>
              ))}
            </div>
          ) : history.length === 0 ? (
