      ...
      {!account ? (
        <section className="rounded-[24px] border border-dashed border-border/60 bg-card p-10 text-center">
          ...
          <p className="mx-auto mt-1.5 max-w-md text-[12px] leading-5 text-muted-foreground">
            Create a financial contract for this
            student to generate installments and
            start recording payments.
          </p>

          {/*
            Keep the existing contract creation
            flow here if ContractsSection owns
            that action.
          */}
        </section>
      ) : (
        <>
              ...
              <div className="grid gap-7 lg:grid-cols-[auto_1fr_auto] lg:items-center">
                ...
                <div className="flex min-w-[190px] flex-col gap-3 rounded-[18px] border border-border/50 bg-muted/[0.18] p-4">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      /*
                       * CashierSection owns the
                       * payment flow.
                       *
                       * The button below is intentionally
                       * kept as a visual payment CTA.
                       */
                    }}
                  >
          ...
          <CashierSection
            ...
            description="Record and review payments made against this account."
            canProcessPayment={
              Number(
