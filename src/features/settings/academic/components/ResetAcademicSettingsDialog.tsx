...
type ResetAcademicSettingsDialogProps = {
  open: boolean;
  isPending: boolean;
...
export function ResetAcademicSettingsDialog({
  open,
  isPending,
  onClose,
  onConfirm,
}: ResetAcademicSettingsDialogProps) {
  const inputRef =
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="reset-academic-title"
      aria-describedby="reset-academic-description"
