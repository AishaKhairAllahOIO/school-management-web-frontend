...
export function FinancialBaseDialog({
  title,
  children,
  onClose,
  description,
...
export function FinancialDialogField({
  label,
  children,
}: {
  label: string;
...
export const financialDialogInputClass = [
...
export function FinancialDialogCheckbox({
  checked,
  onChange,
  label,
}: {
...
export function FinancialDialogActions({
  onClose,
  onSave,
  disabled,
}: {
