  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          role="menu"
          className="topbar-menu-shadow absolute end-0 top-full z-50 mt-4 w-[340px] rounded-[26px] border border-topbar-border/80 bg-topbar-surface/95 p-4 backdrop-blur-2xl"
        >
          <div className="mb-4">
            <h2 className="text-[14px] font-bold text-topbar-title">
              {
                t.layout.topbar
                  .notificationsTitle
              }
          ...
          <div className="scrollbar-thin max-h-[280px] space-y-2 overflow-y-auto pe-1">
            {notifications.length > 0 ? (
              ...
              <p className="py-5 text-center text-[12px] text-topbar-subtle">
                {t.common.noData}
              </p>
            )}
          </div>
